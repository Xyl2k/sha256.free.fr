<?php
	...
	{
		$monfichier = fopen("http://sha256.free.fr/site/lcules/sha384.php5?text=" . $text, "r");
 		$ligne = chop(fgets($monfichier));
		fclose($monfichier);
		return $ligne;
	}
	function sha512($text)
	{
		$monfichier = fopen("http://sha256.free.fr/site/lcules/sha512.php5?text=" . $text, "r");
 		$ligne = chop(fgets($monfichier));
		fclose($monfichier);
		return $ligne;
	}
